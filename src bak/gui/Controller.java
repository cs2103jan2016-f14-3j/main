...
public class Controller implements Initializable{
 ...
 void configureTable() {
        ...
        taskStartDateTime.setCellValueFactory(new PropertyValueFactory<Item, Date>("startDate"));
        taskEndDateTime.setCellValueFactory(new PropertyValueFactory<Item, Date>("endDate"));
    ...
    public void enterCommandFired(ActionEvent event) throws IOException {
        ...
        timeline.getKeyFrames().add(new KeyFrame(Duration.seconds(0), new KeyValue(returnMsg.textProperty(), msg)));
        timeline.getKeyFrames().add(new KeyFrame(Duration.seconds(2), new KeyValue(returnMsg.textProperty(), " ")));
        timeline.play();
        configureTable();
    ...
    public void settingBtnClick(ActionEvent event) throws IOException{
