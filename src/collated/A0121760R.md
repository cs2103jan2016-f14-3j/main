...
```
###### parser\EditRecurringParser.java
``` java
 *
 */
...
public class Parser {
	...
	public Command parse(String userCommand) {
		...
		case CMD_ADD:
			AddParser1 addTaskArgumentParser = new AddParser1(commandArgument,
					false);
			return addTaskArgumentParser.parse();
		case CMD_EVENT:
			AddParser1 addEventArgumentParser = new AddParser1(commandArgument,
					true);
