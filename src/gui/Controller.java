...
public class Controller implements Initializable {
	...
	private void deleteItems(){
		...
		for(int i = 0;i < rows;i++ ){
			System.out.println("arara: "+ checkBox.getCellData(3));
			if(checkBox.getCellData(i) == true){		
				System.out.println("ID: " + Long.parseLong(taskID.getCellData(i).toString()));
				DelCommand delCommand = new DelCommand(Long.parseLong(taskID.getCellData(i).toString()));
				delCommand.execute();
			}
		}
		configureTable();
