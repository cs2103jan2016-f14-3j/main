...
public class NewTaskController implements Initializable {
	...
	// 8. add <task> <today/tomorrow/this week/month/year/ next week/month/year>
	// <f:today/tomorrow/this week/month/year/ next week/month/year>
	// 9. add <task> <dd/mm/yyyy> <f:today/tomorrow/this week/month/year/ next
	// week/month/year>
	// 10. add <task> <dd mmm> <f:today/tomorrow/this week/month/year/ next
	// week/month/year>
	// 11. add <task> <today/tomorrow/this week/month/year/ next
	// week/month/year><f:dd mmm>
	// 12.add <task> <today/tomorrow/this week/month/year/ next
	// week/month/year><f:dd/mm/yyyy>
	...
	private void handleSave() throws IOException, ParseException {
		...
		sc.set(startDate.getYear(), startDate.getMonthValue(),
		...
		ec.set(endDate.getYear(), endDate.getMonthValue(),
		...
		// String input = "add " + "f:";
		// String input = "add " + title + " null " + priority + " Upcoming " +
		// label + " " + startDate + "/" + startTime + " " + endDate + "/" +
		// endTime;
